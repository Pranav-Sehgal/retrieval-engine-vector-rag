...
4. Install our package in editable mode by running: `pip3 install -e .` from the root folder.
...
Run the following command to populate the repository with the remote example assets:
