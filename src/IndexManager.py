...
class IndexManager:
    ...
    def __init__(self,
        ...
        - info: Additional info (e.g., PDF filenames and page numbers where the text has been extracted).
    ...
    def query(self,
        ...
        Returns:
        - references: Retrieved text chunks, along with their info (such as pdf filename and page number).
        Raises:
        - ValueError: If the index has not been created.
        """
        if self.index is None:
    ...
    def chunk_texts_and_info(texts: List[str],
        ...
        For each chunk of text, the corresponding info (e.g., PDF filenames and page numbers) is repeated, maintaining a mapping between chunks and info.
        ...
        for text_cur, info_cur in zip(texts, info):
            ...
            # Repeat info_cur for each element in the chunk to maintain a mapping between chunks and info
